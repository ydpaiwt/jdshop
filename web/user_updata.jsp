			...
			<div class="user_bd mt10">
				<form action="userServlet" method="post">
					...
					<ul>
						...
						<li>
							<label>真实姓名：</label>
							<input type="text" name="realname" class="txt" value="${requestScope.user.realname}"/>
						</li>
						<li>
							<label>性别：</label>
							<c:if test="${requestScope.user.sex.equals('男')}">
							<input type="radio" name="sex" value="男" checked/>男
							</c:if>
							<c:if test="${requestScope.user.sex.equals('女')}">
							<input type="radio" name="sex" value="女"/>女
							</c:if>
						</li>
						<li>
							<label>邮箱：</label>
							<input type="text" name="email" class="txt" value="${requestScope.user.email}"/>
						</li>
						<li>
							<label>手机号码：</label>
							<input type="text" name="phone" class="txt" value="${requestScope.user.phone}"/>
						</li>
						<li>
							<label>&nbsp;</label>
